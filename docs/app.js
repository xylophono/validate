...
/* harmony import */ var _validateDate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validateDate.js */ "./resources/js/validateDate.js");
...
form.addEventListener("submit", function (e) {
  ...
  if (Object(_validateDate_js__WEBPACK_IMPORTED_MODULE_0__["default"])(date)) {
    alert(date + ' is valid');
  } else {
...
/* harmony default export */ __webpack_exports__["default"] = (function (date) {
  ...
  var regex = RegExp("^([0-3][0-9])([\/])([0-1][0-9])([\/])([0-9]{4})$");

  if (!regex.test(date)) {
    return false;
  }

  date = date.split('/'); //Lets deal with the number of days in each month with an object that's keyed to the month number
...
__webpack_require__(/*! C:\Users\Matt\Documents\Websites\validate\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Matt\Documents\Websites\validate\resources\scss\app.scss */"./resources/scss/app.scss");
